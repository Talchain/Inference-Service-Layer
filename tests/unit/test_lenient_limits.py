...
class TestPaulRuledLenientValuePins:
    ...
    def test_compute_admission_ceiling_pinned(self):
        ...
        # units — a DIFFERENT scale). PROVISIONAL: local-hardware calibration;
        # staging recalibration + Paul sign-off owed. Canonical pin + positive
        # controls live in test_admission_calibration.py; this asserts the same
        # constant so a silent revert of the lenient ceiling turns RED here too.
